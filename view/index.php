<?php include_once("header.php");//chama o arquivo header uma única vez?>
		...
		<section>
			...
			<div id="news" class="container"><!-- alinha no meio o conteúdo das notícias -->
				...
				<div class="row thumbnails"><!-- acrescentando classe CSS do owl carousel na div -->
					<!-- divide em 4 colunas com peso 3 o que dá 12 colunas no total (padrão bootstrap) -->
					<div class="item"><!-- O plug-in do JQuery faz o ajuste em colunas automaticamente -->
