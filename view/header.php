...
<html>
	<head ng-app="shop"><!-- manipula a página shop em angularjs-->
		...
		<link rel="stylesheet" href="lib/bootstrap/css/bootstrap.min.css"><!-- chama o arquivo bootstrap -->
		<!-- chamando os arquivos owl carousel para utilizar plug-ins do JQuery -->
		<link rel="stylesheet" href="lib/owl.carousel/owl-carousel/owl.carousel.css">
		<!-- ------------------------------------------------------------------------------------------- -->
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css"><!-- chama a página para colocação dos ícones para colocar no site -->
		<link rel="stylesheet" href="lib/raty/lib/jquery.raty.css"><!-- chama o arquivo para colocar as estrelinhas de avaliação para a loja virtual -->
		<link rel="stylesheet" href="css/orlando.css"><!-- chama o arquivo css -->
		<link rel="stylesheet" href="css/orlando-mobile.css"><!-- chama o arquivo css para mobile -->

		<script src="lib/angularjs/angular.min.js"></script><!-- chama o arquivo angularjs para ser executado no projeto -->
		...
		<header>
			...
			<div class="header-black">
				...
				<div class="container">
					...
					<!-- adicionando os botões para os dispositivos mobile do site do Orlando City -->
